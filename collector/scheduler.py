...
def build_scheduler() -> AsyncIOScheduler:
    ...
    scheduler.add_job(collect, "interval", hours=6,   args=[DevToSource()],   id="collect_devto")
    scheduler.add_job(collect, "interval", hours=3,   args=[RedditSource()],  id="collect_reddit")
